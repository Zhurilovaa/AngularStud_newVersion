...
//import { AddStud, DelStud } from "../store/action/stud.action";
//import {selectStudList} from "../store/selector/stud.selector"
...
export class TableStudComponent {
  ...
  delStudent: Student = new Student(-1,"n", "s", "p",new Date, 0);
  ...
  sortStud(param: string = "key"): void {
